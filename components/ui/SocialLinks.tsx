...
export default function SocialLinks({ className = '' }: SocialLinksProps) {
  const socialLinks = [
    {
      name: 'TikTok',
      url: 'https://www.tiktok.com/@grupoportland',
      icon: (
    ...
    {
      name: 'Facebook',
      url: 'https://www.facebook.com/grupoportland',
      icon: (
        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'Instagram',
      url: 'https://www.instagram.com/grupoportland',
      icon: (
        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
    ...
    {
      name: 'LinkedIn',
      url: 'https://www.linkedin.com/company/grupoportland',
      icon: (
        <svg className="w-6 h-6 fill-current" viewBox="0 0 24 24">
