      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden lg:flex lg:items-center lg:justify-between lg:w-full">
          ...
          <div className="flex items-center space-x-12">
            ...
            <div className="flex flex-col items-center">
              <div className="text-xs text-primary-beige mb-2 text-center tracking-wider">
            ...
            <div className="flex flex-col items-end space-y-2">
              {/* Website */}
              <span className="text-primary-beige font-montreal-medium text-base tracking-wider">
                GRUPOPORTLAND.COM
              </span>
        ...
        <div className="lg:hidden space-y-8">
          ...
          <div className="flex flex-col items-center space-y-6">
            {/* Desarrolla y Construye + Portland Logo */}
            <div className="flex flex-col items-center">
              <div className="text-xs text-primary-beige mb-3 text-center tracking-wider">
                DESARROLLA Y CONSTRUYE
              </div>
