...
export default function Footer() {
  ...
  // Variantes de animación CORREGIDAS - sin overflow
  ...
  // Variantes para elementos individuales - SIN transforms Y
  const itemVariants = {
    hidden: { 
      opacity: 0
    },
  ...
  // Variantes para iconos sociales - SIN scale/y transforms
  ...
  // Variantes para el stagger de iconos sociales
            ...
            >
              ...
              >
                ...
                <motion.div variants={socialIconVariants}>
                  <Link href="#" className="w-10 h-10 bg-primary-beige rounded-full flex items-center justify-center hover:bg-opacity-80 transition-colors">
          ...
          >
            ...
            >
              <span className="text-white font-montreal-medium text-lg tracking-wider">
                <Link href="https://grupoportland.com" target="_blank">
                  GRUPOPORTLAND.COM
                </Link>
              </span>
            </motion.div>
            ...
            >
              {/* TikTok */}
              <motion.div variants={socialIconVariants}>
                <Link href="#" className="text-primary-beige transition-colors">
